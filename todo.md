...
- [x] Make all nickname warning and suggestion options fully visible in both themes.
- [x] Add live nickname availability feedback while typing.
- [x] Replace browser delete confirmation with a themed in-app dialog.
- [x] Add multi-select bulk player deletion in Session history.
- [x] Validate all new nickname and history-management flows.
