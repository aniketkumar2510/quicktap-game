...
export default function Home() {
  ...
  const deleteHistoryPlayer = () => {
    ...
    if (!playerKey || (typeof window !== "undefined" && !window.confirm(`Delete ${playerKey} and every saved score and history entry for this nickname? This cannot be undone.`))) return;
